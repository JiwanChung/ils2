...
class TopMenu {
  constructor($scope, $reactive) {
    ...
    this.tabs= [
    	...
    	{ num: 3, title: '사업단', link: '/affiliation', content: 'sas'},
    	{ num: 4, title: '산하센터', link: '/center', content: 'sas'},
    	{ num: 5, title: '연구원사람들', link: '/people', content: 'sas'},
    	{ num: 6, title: '관련사이트', link: '/links', content: 'sas'}
    ];
  }
}
